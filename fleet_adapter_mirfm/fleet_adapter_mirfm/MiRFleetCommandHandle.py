...
class MiRCommandHandle(adpt.RobotCommandHandle):
    def __init__(self,
        ...
        self.mir_api: MirAPI | None = None  # MiR REST API
        ...
        # mapping between rmf level to mir map guid
    ...
    def queue_rmf_move_coordinate_mission(self, mir_location):
        ...
        mission = {
            ...
            'parameters': [
                {'input_name': 'X', 'value': mir_location.x},
                {'input_name': 'Y', 'value': mir_location.y},
                {'input_name': 'Orientation', 'value': mir_location.yaw},
            ],
            "priority": 0,
