...
class PostMissionGroups(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, feature, icon, name, priority, *args, **kwargs):  # noqa: E501
        """PostMissionGroups - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, feature, icon, name, priority, *args, **kwargs):  # noqa: E501
        """PostMissionGroups - a model defined in OpenAPI
