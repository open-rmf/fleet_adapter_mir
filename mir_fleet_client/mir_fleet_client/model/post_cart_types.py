...
class PostCartTypes(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, height, length, name, offset_locked_wheels, width, *args, **kwargs):  # noqa: E501
        """PostCartTypes - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, height, length, name, offset_locked_wheels, width, *args, **kwargs):  # noqa: E501
        """PostCartTypes - a model defined in OpenAPI
