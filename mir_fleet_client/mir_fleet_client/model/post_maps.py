...
class PostMaps(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, map, metadata, name, origin_theta, origin_x, origin_y, resolution, session_id, *args, **kwargs):  # noqa: E501
        """PostMaps - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            one_way_map (str): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, map, metadata, name, origin_theta, origin_x, origin_y, resolution, session_id, *args, **kwargs):  # noqa: E501
        """PostMaps - a model defined in OpenAPI
