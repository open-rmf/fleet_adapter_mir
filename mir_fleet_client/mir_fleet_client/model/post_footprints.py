...
class PostFootprints(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, config_id, footprint_points, height, hook, name, *args, **kwargs):  # noqa: E501
        """PostFootprints - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, config_id, footprint_points, height, hook, name, *args, **kwargs):  # noqa: E501
        """PostFootprints - a model defined in OpenAPI
