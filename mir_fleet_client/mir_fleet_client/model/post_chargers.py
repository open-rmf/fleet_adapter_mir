...
class PostChargers(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, charger_id, group_id, *args, **kwargs):  # noqa: E501
        """PostChargers - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, charger_id, group_id, *args, **kwargs):  # noqa: E501
        """PostChargers - a model defined in OpenAPI
