...
class PostMissions(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, group_id, name, *args, **kwargs):  # noqa: E501
        """PostMissions - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            description (str): Max length: 255. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, group_id, name, *args, **kwargs):  # noqa: E501
        """PostMissions - a model defined in OpenAPI
