...
class PostPathGuidesPrecalc(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, command, guid, *args, **kwargs):  # noqa: E501
        """PostPathGuidesPrecalc - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, command, guid, *args, **kwargs):  # noqa: E501
        """PostPathGuidesPrecalc - a model defined in OpenAPI
