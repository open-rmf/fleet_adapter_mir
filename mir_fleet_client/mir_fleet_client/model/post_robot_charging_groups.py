...
class PostRobotChargingGroups(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, group_id, robot_id, *args, **kwargs):  # noqa: E501
        """PostRobotChargingGroups - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, group_id, robot_id, *args, **kwargs):  # noqa: E501
        """PostRobotChargingGroups - a model defined in OpenAPI
