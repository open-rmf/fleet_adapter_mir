...
class PostPathGuides(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, map_id, name, *args, **kwargs):  # noqa: E501
        """PostPathGuides - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, map_id, name, *args, **kwargs):  # noqa: E501
        """PostPathGuides - a model defined in OpenAPI
