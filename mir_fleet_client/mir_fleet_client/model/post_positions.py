...
class PostPositions(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, map_id, name, orientation, pos_x, pos_y, type_id, *args, **kwargs):  # noqa: E501
        """PostPositions - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, map_id, name, orientation, pos_x, pos_y, type_id, *args, **kwargs):  # noqa: E501
        """PostPositions - a model defined in OpenAPI
