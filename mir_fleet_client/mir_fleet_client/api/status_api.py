...
class StatusApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.status_put_endpoint = _Endpoint(
            settings={
                'response_type': (GetState,),
                'auth': [
                    'Basic'
    ...
    def status_get(
        ...
        **kwargs
        ...
        Retrieve the state of the fleet  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.status_get(accept_language="en_US", async_req=True)
        >>> result = thread.get()
    ...
    def status_put(
        ...
        **kwargs
        ...
        Modify the state of the fleet  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.status_put(state, accept_language="en_US", async_req=True)
        >>> result = thread.get()

        Args:
            state (PutState): The new values of the state
            accept_language (str): Language header. defaults to "en_US", must be one of ["en_US"]
        ...
        kwargs['state'] = \
            state
        return self.status_put_endpoint.call_with_http_info(**kwargs)
