...
class SettingsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.settings_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetSetting,),
                'auth': [
                    'Basic'
                ],
                'endpoint_path': '/settings/{id}',
                'operation_id': 'settings_id_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.settings_id_put_endpoint = _Endpoint(
            settings={
                'response_type': (GetSetting,),
                'auth': [
                    'Basic'
    ...
    def settings_get(
        ...
        **kwargs
        ...
        >>> thread = api.settings_get(accept_language="en_US", async_req=True)
        >>> result = thread.get()
    ...
    def settings_id_get(
        ...
        **kwargs
        ...
        >>> thread = api.settings_id_get(id, accept_language="en_US", async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.settings_id_get_endpoint.call_with_http_info(**kwargs)
    ...
    def settings_id_put(
        ...
        **kwargs
        ...
        >>> thread = api.settings_id_put(id, setting, accept_language="en_US", async_req=True)
        >>> result = thread.get()

        Args:
            id (str): The id to modify
            setting (PutSetting): The new values of the setting
            accept_language (str): Language header. defaults to "en_US", must be one of ["en_US"]
        ...
        kwargs['setting'] = \
            setting
        return self.settings_id_put_endpoint.call_with_http_info(**kwargs)
