...
class RestartApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.restart_post_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'Basic'
                ],
                'endpoint_path': '/restart',
                'operation_id': 'restart_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def restart_post(
        ...
        **kwargs
        ...
        Initiate restart of the system  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.restart_post(accept_language="en_US", async_req=True)
        >>> result = thread.get()
        ...
        kwargs['accept_language'] = \
            accept_language
        return self.restart_post_endpoint.call_with_http_info(**kwargs)
