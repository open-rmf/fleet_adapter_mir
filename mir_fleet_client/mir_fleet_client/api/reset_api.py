...
class ResetApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.reset_post_endpoint = _Endpoint(
            settings={
    ...
    def reset_post(
        ...
        **kwargs
        ...
        Initiate reset of the system  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.reset_post(accept_language="en_US", async_req=True)
        >>> result = thread.get()
        ...
        kwargs['accept_language'] = \
            accept_language
        return self.reset_post_endpoint.call_with_http_info(**kwargs)
