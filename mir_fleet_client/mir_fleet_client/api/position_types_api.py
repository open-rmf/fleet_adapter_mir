...
class PositionTypesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.position_types_get_endpoint = _Endpoint(
            settings={
                'response_type': ([GetPositionTypes],),
                'auth': [
                    'Basic'
                ],
                'endpoint_path': '/position_types',
                'operation_id': 'position_types_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.position_types_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetPositionType,),
                'auth': [
                    'Basic'
                ],
                'endpoint_path': '/position_types/{id}',
                'operation_id': 'position_types_id_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def position_types_get(
        ...
        **kwargs
        ...
        >>> thread = api.position_types_get(accept_language="en_US", async_req=True)
        >>> result = thread.get()
        ...
        kwargs['accept_language'] = \
            accept_language
        return self.position_types_get_endpoint.call_with_http_info(**kwargs)

    def position_types_id_get(
        self,
        id,
        accept_language="en_US",
        **kwargs
        ...
        >>> thread = api.position_types_id_get(id, accept_language="en_US", async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.position_types_id_get_endpoint.call_with_http_info(**kwargs)
